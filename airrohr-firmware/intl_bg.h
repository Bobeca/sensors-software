...
const char INTL_FS_WIFI_BESCHREIBUNG[] PROGMEM = "WiFi сензор в режим на конфигуриране";
...
const char INTL_USE_BETA[] PROGMEM = "Зареди бета фърмуер";
...
const char INTL_ZEIT_SEIT_LETZTER_MESSUNG[] PROGMEM = " секунди от последното измерване.";
...
const char INTL_ANZAHL_MESSUNGEN[] PROGMEM = "Брой измервания";
